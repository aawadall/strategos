...
([v0.3.0-alpha.4](https://github.com/aawadall/strategos/releases/tag/v0.3.0-alpha.4)).
...
- Zip: `Strategos-0.3.0-alpha.4-windows.zip` from the GitHub Release, **or**
...
.\scripts\itch-push.ps1 -Source path\to\Strategos-0.3.0-alpha.4-windows.zip
# or
