...
**Status:** Policy seam (#100), observation (#101), action space (#102), and reward (#103)
shipped; env lifecycle (#104) and rest of epic (#99) unbuilt.
...
- [ ] **Environment API** (remaining): lifecycle (#104)
