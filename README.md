...
[![GitHub Release](https://img.shields.io/badge/GitHub-v0.3.0--alpha.2_zip-2c5a38)](https://github.com/aawadall/strategos/releases/tag/v0.3.0-alpha.2)
...
- **Play:** [itch.io (PWYW · $2 default)](https://aawadall.itch.io/strategos) ·
  [v0.3.0-alpha.2 Windows zip](https://github.com/aawadall/strategos/releases/tag/v0.3.0-alpha.2)
...
#   .\scripts\build.ps1 -Target Windows64 -Version 0.3.0-alpha.2
```
