...
This roadmap describes the phased development of Strategos from initial prototype to full release. Each phase ends with a functional, testable milestone. Phases are sequential at the macro level, but tasks within a phase may progress in parallel.

---

## Echelon Reference

The full progression a player can command, using NATO APP-6D echelon designators:
...
- [ ] Echelon designator renderer (all 12 echelon marks, see table above)
